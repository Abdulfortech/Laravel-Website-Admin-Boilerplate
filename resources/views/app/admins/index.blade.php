          ...
          <div class="col-12">
            <div class="card mb-4">
              <div class="card-header pb-0">
                ...
                <a href="{{route('admin.showAdd')}}" class="float-end btn btn-success btn-sm" class="float-end btn btn-success"><i class="fa fa-plus"></i> Add </a>
              </div>
                    ...
                    <tbody>
                      @php($count = 1)
                        ...
                        <tr>
                            ...
                            <td>{{$admin->status}}</td>
                            <td>
                              <a href="{{route('admin.showView',[$admin->id])}}" class="btn btn-success"><i class="fa fa-eye"></i></a>
