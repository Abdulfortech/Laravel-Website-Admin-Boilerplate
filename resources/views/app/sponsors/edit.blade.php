        ...
        <div class="col-md-9 mx-auto">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h4 class="text-center">Edit Sponsor</h4>
            </div>
            <div class="card-body pt-0 pb-2">
                <form id="addClientForm" enctype="multipart/form-data" action="{{route('sponsor.update', [$sponsor->id])}}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group my-0">
                                <label for="example-text-input" class="form-control-label">Name</label>
                                <input class="form-control" name="name" value="{{$sponsor->name}}" type="text" required>
                                @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group my-0">
                                ...
                                <select class="form-control" name="category" required>
                                    <option>{{$sponsor->category}}</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group my-0">
                                ...
                                <select name="display" id="display"  class="form-control" >
                                    <option  value="{{$sponsor->display}}">{{ $sponsor->display == 1 ? "True": "False" }}</option>
