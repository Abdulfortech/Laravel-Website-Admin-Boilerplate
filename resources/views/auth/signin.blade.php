                    ...
                    <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                        <div class="card card-plain">
                            <div class="card-header ps-0 pb-0 text-start">
                                <h1 class="font-weight-bolder">Kaid Charity Foundarion</h1>
                            ...
                            <div class="card-body">
                                ...
                                <form role="form" id="login-form" action="{{ route('signin') }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
                                        <input type="text" class="form-control form-control-lg" name="email" placeholder="Email" id="email" aria-label="Email" required>
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-lg btn-success btn-lg w-100 mt-4 mb-0" id="submitButton">Sign in</button>
                                </div>
                                </form>
                            </div>
                            <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                ...
                                {{-- Forgot Password?
                                <a href="forgot-password" class="text-success text-gradient font-weight-bold">Reset</a> --}}
                                </p>
                            </div>
                        </div>
                    </div>
